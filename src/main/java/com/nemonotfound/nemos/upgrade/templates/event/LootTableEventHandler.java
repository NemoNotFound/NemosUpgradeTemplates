...
public class LootTableEventHandler {
    ...
    private static LootPool createCommonUpgradeTemplateLootPool(int commonWeight) {
        ...
        return LootPool.lootPool()
                ...
                .add(LootItem.lootTableItem(UpgradeTemplateItems.COPPER_UPGRADE_SMITHING_TEMPLATE).setWeight(commonWeight))
                .add(LootItem.lootTableItem(UpgradeTemplateItems.IRON_UPGRADE_SMITHING_TEMPLATE).setWeight(commonWeight))
    ...
    private static LootPool createRareUpgradeTemplateLootPool(int rareWeight) {
        ...
        return LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
                .add(LootItem.lootTableItem(UpgradeTemplateItems.GOLD_UPGRADE_SMITHING_TEMPLATE).setWeight(rareWeight))
                .add(LootItem.lootTableItem(UpgradeTemplateItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE).setWeight(rareWeight))
                .add(EmptyLootItem.emptyItem().setWeight(emptyItemWeight))
                .build();
    }
